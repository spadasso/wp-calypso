...
import { getTwoFactorAuthRequestError, isRequestingTwoFactorAuth } from 'state/login/selectors';
...
class VerificationCodeForm extends Component {
	...
	onCodeSubmit = event => {
		...
		this.props
			.loginUserWithTwoFactorVerificationCode( twoStepCode, rememberMe, twoFactorAuthType )
			.then( () => {
