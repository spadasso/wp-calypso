					...
					<CommentNavigationTab className="comment-navigation__actions">
						...
						<ButtonGroup>
							{ this.statusHasAction( 'spam' ) &&
								<Button compact disabled={ ! selectedCount } onClick={ setBulkStatus( 'spam' ) }>
									{ translate( 'Spam' ) }
								</Button> }
							{ this.statusHasAction( 'trash' ) &&
								<Button compact disabled={ ! selectedCount } onClick={ setBulkStatus( 'trash' ) }>
									{ translate( 'Trash' ) }
								</Button> }
							{ this.statusHasAction( 'delete' ) &&
								<Button compact disabled={ ! selectedCount } onClick={ setBulkStatus( 'delete' ) }>
									{ translate( 'Delete' ) }
								</Button> }
						</ButtonGroup>
					</CommentNavigationTab>
